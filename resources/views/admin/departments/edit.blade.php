                    ...
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                        <form method="POST" action="{{ route('admin.departments.update', $department->id) }}">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="name" name="name_dep" value="{{ $department->name_dep }}"
                            ...
                            <div class="sm:col-span-6 mt-6">
                                ...
                                <select id="faculty" name="faculty_id"
                                    ...
                                    <option value="{{ $department->faculty_id }}">{{ optional($department->faculty)->name_fac?? 'Faculty deleted' }}</option>
                                    @foreach ($faculties as $faculty)
                                        @if ($faculty->name_fac == optional($department->faculty)->name_fac?? 'Faculty deleted')
