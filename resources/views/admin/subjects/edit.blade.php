            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <div class="flex p-2">
                    <a href="{{ route('admin.subjects.index') }}"
                        class="px-4 py-2 bg-green-700 hover:bg-green-500 text-slate-100 rounded-md">Subject Index</a>
                </div>
                    ...
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                        <form method="POST" action="{{ route('admin.subjects.update', $subject->id) }}">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="name" name="name_sub" value="{{ $subject->name_sub }}"
                            ...
                            <div class="sm:col-span-6 mt-6">
                                ...
                                <select id="department" name="department_id"
                                    ...
                                    <option value="{{ $subject->department_id }}">{{ optional($subject->department)->name_dep ?? 'Department deleted' }}</option>
                                    @foreach ($departments as $department)
                                        @if ($department->name_dep == optional($subject->department)->name_dep ?? 'Department deleted')
