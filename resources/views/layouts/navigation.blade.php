<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('hall.index2','day')" :active="request()->routeIs('hall.index')">
                        {{ __('Hall Booking') }}
                    </x-nav-link>
                    <x-nav-link :href="route('hall.show',$userId)" :active="request()->routeIs('hall.show')">
                        {{ __('My Books') }}
                    </x-nav-link>
                    @role('Admin')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('hall.index')" :active="request()->routeIs('hall.index')">
                {{ __('Hall') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('hall.show',$userId)" :active="request()->routeIs('hall.show')">
                {{ __('My Books') }}
            </x-responsive-nav-link>
            @role('admin')
