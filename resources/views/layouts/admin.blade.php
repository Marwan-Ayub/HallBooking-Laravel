    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-link :href="route('hall.index2','day')" :active="request()->routeIs('hall.index')">Hall Booking
                </x-admin-link>
                ...
                {{-- <x-admin-link :href="route('admin.permissions.index')"
                    :active="request()->routeIs('admin.permissions.index')">Permissions
                </x-admin-link> --}}
                <x-admin-link :href="route('admin.users.index')" :active="request()->routeIs('admin.users.index')">Users
                </x-admin-link>
                <x-admin-link :href="route('admin.halls.index')" :active="request()->routeIs('admin.halls.index')">Halls
                </x-admin-link>
                <x-admin-link :href="route('admin.subjects.index')" :active="request()->routeIs('admin.subjects.index')">Subjects
                </x-admin-link>
                <x-admin-link :href="route('admin.times.index')" :active="request()->routeIs('admin.times.index')">Times
                </x-admin-link>
                <x-admin-link :href="route('admin.departments.index')" :active="request()->routeIs('admin.departments.index')">Departments
                </x-admin-link>
                <x-admin-link :href="route('admin.faculties.index')" :active="request()->routeIs('admin.faculties.index')">Faculties
                </x-admin-link>
